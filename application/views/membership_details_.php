<script type="text/javascript">
	...
	function payMode(){	
		if(document.getElementById('payment_mode2').checked==true){
			if(document.getElementById('full_payment0').checked==true) {
				document.getElementById('full_payment0').checked=false;
				document.getElementById('full_payment1').checked=true;
			}
			document.getElementById('mpay').style.display = "none"
		}else {
			document.getElementById('mpay').style.display = "block"
		}
	};	
