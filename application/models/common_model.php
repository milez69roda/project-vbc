...
class Common_Model extends CI_Model { 
	...
	public function sendMemberEmail($orderRef,$send){
		...
		if($promo_name != ''){
			$message .='<tr valign="top"><td width="38%"><div align="right">Discount</div></td>
			<td width="4%"><div align="center">:</div></td>
			<td width="58%"><div align="left">S$'.$promo_name.'</div></td></tr>';
		}
		...
		$data['attachements'] = array(base_url().'files/terms.pdf');	 
		return $data;
	}	
